...
flags.DEFINE_string("checkpoint_disp_continue", "", "From which model it continues training")
flags.DEFINE_string("checkpoint_flow_continue", "", "from which model to continue train flow")
