\begin{abstract}
    Learning to reconstruct 2.5D geometry from a single image in an unsupervised manner with deep convolutional network (DCN) \cite{zhou2017unsupervised} is attracting significant attention in recent years, due to that it can be widely applied to unlabeled videos online for applications such as augmented reality etc.
