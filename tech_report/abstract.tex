\begin{abstract}
    ...
    In this paper, we introduce normal representation for the unsupervised depth estimation pipeline, and our estimated depths are guaranteed to be compatible with predicted normals, yielding more robust geometry results. 
    ...
    We conducted experiments on both outdoor (KITTI) and indoor (NYUv2) videos, and show that our algorithm vastly outperforms the state-of-arts, reducing both depth and normal errors over relative 20$\%$ and 10$\%$ respectively, which demonstrates the benefits from our approach.
\end{abstract}
