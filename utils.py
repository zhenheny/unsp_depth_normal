...
def generate_image(img, depth, pix2cam2, cam2pix1, ext1, ext2, target_image):
    """Warp the image from view1 to view2 based on extrinsics of both views
    Args:
        img: the image of view1 -- [B, H, W, 3]
        depth: depth map of view2 -- [B, H, W]
        cam2pix, pix2cam: intrinsics and inv_intrinsics of two views -- [B, 3, 3]
        ext: extrinsics of two views -- [B, 4, 4]

    Returns:
        Image of view1 warped to view2 and flyout mask
    """
