/opt/python3.5/bin/python3.5 train.py \
    --dataset_dir=/home/peng/Data/citydriving/frame_seq_640_384_gap3/ \
    --eval_data_path=/home/peng/Data/kitti/ \
	--checkpoint_dir=./output/cs_4pt0.0_noflyout_dilated2_d2nnei3_n2dedgeremove_depthsmooth_noedge_wedgel2_alpha10_clip0_wt2_edge_lossscalefactor_input417_l2_deconvk4_nnupsample_noscaling_wt0.2_expwt0.0_dm_xz_2loss_l1wt0.01_depth4pose_depth1normal_eval_edgepretrained_cd_pwc \
	--eval_txt=ektc_4pt0.0_noflyout_dilated2_d2nnei3_n2dedgeremove_depthsmooth_noedge_wedgel2_alpha10_clip0_wt2_edge_lossscalefactor_input417_l2_deconvk4_nnupsample_noscaling_wt0.2_expwt0.0_dm_xz_2loss_l1wt0.01_depth4pose_depth1normal_eval_edgepretrained_cd_pwc_m.txt \
	--img_width=640 \
    --img_height=384 \
    --batch_size=3 \
	--smooth_weight=2 \
    ...
    --checkpoint_continue=./output/init_model/stereo/model-100002
