python3 train.py --dataset_dir=/home/zhenheng/datasets/kitti/eigen_process_832_256 \
	--checkpoint_dir=/home/zhenheng/tf_events/unsp_depth_normal/d2nn2d_4pt0.0_noflyout_dilated2_1warping_depthsmooth_wedgel2_wt2_edgel2_noscaling_wt0.2_expwt0.4_sfmpy0723_depth1normal_eval_cont \
	--eval_txt eval_kitti_d2nn2d_4pt0.0_noflyout_dilated2_1warping_depthsmooth_wedgel2_wt2_edgel2_noscaling_wt0.2_expwt0.4_sfmpy0723_depth1normal_eval_cont.txt \
	--img_width=832 --img_height=256 --batch_size=4 \
	--smooth_weight=2 --explain_reg_weight=0.4 --edge_mask_weight=0.2 --edge_as_explain 0.0\
