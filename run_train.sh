python3 train.py --dataset_dir=/home/zhenheng/datasets/kitti/eigen_process_832_256 \
	--checkpoint_dir=/home/zhenheng/tf_events/unsp_depth_normal/d2nn2d_4pt0.0_noflyout_dilated2_depthsmooth_wedgesmooth0.5_expwt0.0_sfmpy0723_depth1normal_eval \
	--eval_txt eval_kitti_d2nn2d_4pt0.0_noflyout_dilated2_depthsmooth_wedgesmooth0.5_expwt0.0_sfmpy0723_depth1normal_eval.txt \
	--img_width=832 --img_height=256 --batch_size=4 \
	--smooth_weight=0.2 --normal_smooth_weight=0 --img_grad_weight=0 --explain_reg_weight=0.0 --occ_mask=0.0 --depth_consistency=0.0 --edge_mask_weight=0.2\
